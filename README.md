...
```
eIDs, eInfo = one.search(lab='CortexLabUCL', subject='hercules', required_data=['spikes.times', 'spikes.brain_location','headTracking.xyPos'])
```
